...
import { LogItem, ChannelStats } from '@/lib/api';
...
interface ChannelLogPageProps {
  channel: Channel;
  fetchLogs: (page?: number, pageSize?: number) => Promise<{ data: LogItem[]; total: number; page: number; page_size: number }>;
  fetchStats: () => Promise<ChannelStats>;
}

export default function ChannelLogPage({ channel, fetchLogs, fetchStats }: ChannelLogPageProps) {
  ...
  }, [fetchLogs, fetchStats, page, pageSize, totalPages]);
